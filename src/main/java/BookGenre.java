public enum BookGenre {
        ...
        CHILDRENS_PICTURE_BOOK("Children's Picture Book", "Books that are illustrated with " +
                "pictures and are designed for young children"),
        CHILDRENS_CHAPTER_BOOK("Children's Chapter Book", "Books that are aimed at older children and are divided into chapters"),
