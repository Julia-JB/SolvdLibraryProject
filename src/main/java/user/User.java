...
public class User implements Formattable {
    ...
    /**
     * This method overrides equals() method to compare User.User objects based on their names
    ...
    /**
     * This method overrides hashCode() method based on User.User object name and phone number properties
     * @return
     */
    @Override
    public int hashCode() {
