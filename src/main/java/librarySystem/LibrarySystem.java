...
import lambdaFunctions.MapStringLambda;
...
public class LibrarySystem {
     ...
     * @return List<libraryItem.LibraryItem>
     */
    public static List<LibraryItem> getItemsNotAvailable() {
        Logger logger = LogManager.getLogger();
     ...
     * @return List<String>
     */
    public static List<String> getBooksBasicInfo() {
